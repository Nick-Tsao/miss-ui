<template>
  <demo-section>
    <demo-block :title="$t('ellipsis')">
      <div class="ms-ellipsis">{{ $t('text') }}</div>
    </demo-block>

    <demo-block :title="$t('hairline')">
      <div class="ms-hairline--top" />
    </demo-block>
    ...
    <demo-block :title="$t('animation')">
      <ms-cell
        is-link
        title="Fade"
        @click="animate('ms-fade')"
      />
      <ms-cell
        is-link
        title="Slide Up"
        @click="animate('ms-slide-up')"
      />
      <ms-cell
        is-link
        title="Slide Down"
        @click="animate('ms-slide-down')"
      />
      <ms-cell
        is-link
        title="Slide Left"
        @click="animate('ms-slide-left')"
      />
      <ms-cell
        is-link
        title="Slide Right"
        @click="animate('ms-slide-right')"
      />
    </demo-block>
