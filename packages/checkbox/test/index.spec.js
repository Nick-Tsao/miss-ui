...
test('switch checkbox', () => {
  ...
  const icon = wrapper.find('.ms-checkbox__icon');
  icon.trigger('click');
  icon.trigger('click');
...
test('disabled', () => {
  ...
  wrapper.find('.ms-checkbox__icon').trigger('click');
...
test('label disabled', () => {
  ...
  wrapper.find('.ms-checkbox__label').trigger('click');
  expect(wrapper.emitted('input')).toBeFalsy();
});
...
test('checkbox group', () => {
  ...
  const icons = wrapper.findAll('.ms-checkbox__icon');
