<template>
  <demo-section>
    <demo-block :title="$t('basicUsage')">
      <ms-collapse v-model="active1">
        <ms-collapse-item :title="$t('title1')">{{ $t('content1') }}</ms-collapse-item>
        <ms-collapse-item :title="$t('title2')">{{ $t('content2') }}</ms-collapse-item>
        <ms-collapse-item
          :title="$t('title3')"
          disabled
        >
    ...
    <demo-block :title="$t('accordion')">
      ...
      >
        <ms-collapse-item :title="$t('title1')">{{ $t('content1') }}</ms-collapse-item>
        <ms-collapse-item :title="$t('title2')">{{ $t('content2') }}</ms-collapse-item>
        <ms-collapse-item :title="$t('title3')">{{ $t('content3') }}</ms-collapse-item>
      </ms-collapse>
    </demo-block>

    <demo-block :title="$t('titleSlot')">
      <ms-collapse v-model="active3">
        <ms-collapse-item>
          <div slot="title">{{ $t('title1') }}<ms-icon name="question-o" /></div>
          {{ $t('content1') }}
        </ms-collapse-item>
        <ms-collapse-item
          :title="$t('title2')"
