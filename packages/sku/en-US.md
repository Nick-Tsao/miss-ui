...
>
  ...
  <template slot="sku-header-price" slot-scope="props">
    <div class="ms-sku__goods-price">
      <span class="ms-sku__price-symbol">￥</span><span class="ms-sku__price-num">{{ props.price }}</span>
    </div>
  </template>
  <!-- custom sku actions -->
  <template slot="sku-actions" slot-scope="props">
    <div class="ms-sku-actions">
      <ms-button bottom-action @click="onPointClicked">Button</ms-button>
      <!-- trigger sku inner event -->
      <ms-button type="primary" bottom-action @click="props.skuEventBus.$emit('sku:buy')">Button</ms-button>
    </div>
  </template>
</ms-sku>
```
