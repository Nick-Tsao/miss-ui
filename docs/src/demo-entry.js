...
export default {
  ...
  'amount': () => wrapper(import('../../packages/amount/demo'), 'amount'),
  ...
  'landscape': () => wrapper(import('../../packages/landscape/demo'), 'landscape'),
  ...
  'result-page': () => wrapper(import('../../packages/result-page/demo'), 'result-page'),
  ...
  'water-mark': () => wrapper(import('../../packages/water-mark/demo'), 'water-mark'),
