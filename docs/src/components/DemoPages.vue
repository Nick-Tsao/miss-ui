<template>
  <section class="ms-doc-demo-pages">
    <h2>{{ $t('title') }}</h2>
    <p>{{ $t('description') }}</p>
    <div class="ms-doc-demo-pages__gallery">
      <div
        :class="['ms-doc-demo-pages__item', { 'ms-doc-demo-pages__item--active': index === currentDemo }]"
